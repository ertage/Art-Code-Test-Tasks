...
public class ArrayHelper {
    ...
    public static int[] maxAverageHalfOfArray(int[] array) {
        ...
        int counter = 0;
        int indexOfHalf = array.length / 2;


        for (int i = 0, j = indexOfHalf; i < indexOfHalf; i++, j++) {
            counter++;
            sumFirstPart = array[i] + sumFirstPart;
            sumSecondPart = array[j] + sumSecondPart;
        }


        averageFirstPart = sumFirstPart / (counter / 2);
        averageSecondPart = sumSecondPart / (counter / 2);
