...
public class Main {
    ...
    public static void testFirstLast6() {
    ...
    public static void testCommonEnd() {
    ...
    public static void testMiddleWay() {
    ...
    public static void testMakeMiddle() {
    ...
    public static void testMidThree() {
    ...
    public static void testUnlucky1() {
